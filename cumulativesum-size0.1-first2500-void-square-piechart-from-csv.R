...
countcolourname$cumsumnumphotos <- cumsum(countcolourname$freq)
countcolourname <- subset(countcolourname, countcolourname$cumsumnumphotos < 1001)
colour_vector2 <-setNames(countcolourname$freq, countcolourname$colourname)
colour_vector2
sum(colour_vector2)

p = waffle(colour_vector2 , rows=25, size= 0.1, colors = countcolourname$colourname) +
    # theme_void() +
...
ggsave(paste0("cumulative-sum-1000-first2500-div5-size0.1-square-piechart-colourname-",gsub("csv", "png", basename(args[1]))), p,
