...
main <- function() {
  print("letters1000 actually 657:")
  print(letters1000)
  data3 = read.csv(
    file = "02-january2016-ig-van-avgcolour-id-mf-month-day-daynum-unixtime-hour.csv",
    stringsAsFactors = F)
  numphotos = 3000
  print(numphotos)
  ...
  filename = sprintf(
    "%4.4d-%s",
    numphotos,
    "debugwaffle-02-january2016-ig-van-avgcolour-id-mf-month-day-daynum-unixtime-hour.png"
  )
  ggsave(filename,
         p,
         width = 14.222222222,
