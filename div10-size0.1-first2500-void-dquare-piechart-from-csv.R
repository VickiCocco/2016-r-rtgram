...
p = waffle(colour_vector2 / 10 , rows=25, size= 0.1, colors = countcolourname$colourname) +
    # theme_void() +
...
ggsave(paste0("first2500-div10-size0.1-square-piechart-colourname-",gsub("csv", "png", basename(args[1]))), p,
